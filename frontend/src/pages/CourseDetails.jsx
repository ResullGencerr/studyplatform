...
function CourseDetails() {
  ...
  useEffect(() => {
    const fectchCourseDetailsData = async () => {
      try {
        ...
        console.log("Kurs detayları getirilemedi");
      }
    };
  ...
  const handleBuyCourse = () => {
    ...
    setConfirmationModal({
      ...
      text2: "Kursu satın almak için lütfen giriş yapın.",
      btn1Text: "Giriş Yap",
      btn2Text: "İptal",
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-cente py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div className="text-md flex flex-wrap items-center gap-2">
                ...
                <span>{`(${ratingAndReviews.length} yorum)`}</span>
                <span>{`${studentsEnrolled.length} öğrenci kayıtlı`}</span>
              </div>
              ...
              <div className="flex flex-wrap gap-5 text-lg">
                <p className="flex items-center gap-2">
                  <BiInfoCircle /> Oluşturulma tarihi: {formatDate(createdAt)}
                </p>
                <p className="flex items-center gap-2">
                  {" "}
                  <HiOutlineGlobeAlt /> Dil: İngilizce
                </p>
              </div>
            </div>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <p className="text-xl font-bold">Etiketler</p>
          ...
          <div className="max-w-[830px] mt-9">
            <div className="flex flex-col gap-3">
              <p className="text-[28px] font-semibold">Kurs İçeriği</p>
              <div className="flex flex-wrap justify-between gap-2">
                <div className="flex gap-2">
                  <span>{courseContent.length} bölüm</span>
                  <span>{totalNoOfLectures} ders</span>
                  <span>{response.data?.totalDuration} toplam süre</span>
                </div>
                <button
            ...
            <div className="mb-12 py-4">
              <p className="text-[28px] font-semibold">Eğitmen</p>
