...
const Navbar = () => {
  ...
  // Aktif sayfa kontrolü (link rengi için)
  const matchRoute = (route) => {
    return matchPath({ path: route }, location.pathname);
  };

  // Kullanıcı aşağı kaydırdığında navbar gizlenir, yukarı çıkarsa görünür
  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between ">
        ...
        {/* Büyük ekranlar için nav linkleri */}
        ...
        <div className="flex gap-x-4 items-center">
          ...
          {/* Büyük ekranlarda kullanıcı menüsü */}
          {token !== null && <ProfileDropDown />}

          {/* Küçük ekranlar için kullanıcı menüsü */}
