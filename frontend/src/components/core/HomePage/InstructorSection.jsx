      ...
      <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center">
        ...
        <div className="lg:w-[50%] flex flex-col">
          <div className="text-3xl lg:text-4xl font-semobold w-[50%] mb-2">
            Eğitmen
            <HighlightText text={"Olun"} />
          </div>

          <p className="font-medium text-[16px] w-[80%] text-richblack-300 mb-12">
            Dünyanın dört bir yanından eğitmenler StudyNotion üzerinden
            milyonlarca öğrenciye eğitim veriyor. Sevdiğiniz şeyi öğretmeniz
            için size gerekli araçları ve becerileri sağlıyoruz.
          </p>
