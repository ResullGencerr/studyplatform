...
const timeline = [
  {
    Logo: Logo1,
    heading: "Liderlik",
    Description: "Şirketin başarısına tamamen bağlıyız",
  },
  {
    Logo: Logo2,
    heading: "Sorumluluk",
    Description: "Öğrenciler her zaman en büyük önceliğimiz olacak",
  },
  {
    Logo: Logo3,
    heading: "Esneklik",
    Description: "Geçiş yapabilme becerisi önemli bir yetenektir",
  },
  {
    Logo: Logo4,
    heading: "Sorun Çözme",
    Description: "Çözüme giden yolu kodlayarak bulun",
  },
];
            ...
            return (
              <div className="flex flex-row gap-6" key={index}>
                <div className="w-[50px] h-[50px] rounded-full bg-richblue-500 flex justify-center items-center">
                  <img src={element.Logo} alt={`${element.heading} simge`} />
                </div>
                <div>
