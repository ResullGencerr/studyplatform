    ...
    <div className="mt-5 w-full flex flex-col justify-between rounded-xl ">
      ...
      <div className="flex flex-col gap-y-6 mt-5">
        <div className="flex justify-between">
          <p className="text-lg font-bold text-richblack-5 pl-5">Kurslarınız</p>
    ...
    <div>
      <div className="space-y-2">
        ...
        <p className="font-medium text-richblack-200 text-center sm:text-left">
          Hadi yeni bir şeylere başlayalım
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex h-[450px] space-x-4">
            {totalAmount > 0 || totalStudents > 0 ? (
              ...
              <div className="flex-1 rounded-md bg-richblack-800 p-6">
                ...
                <p className="mt-4 text-xl font-medium text-richblack-50">
                  Görselleştirme için yeterli veri yok
                </p>
              </div>
            )}
            ...
            <div className="flex min-w-[250px] flex-col rounded-md bg-richblack-800 p-6">
              ...
              <div className="mt-4 space-y-4">
                <div>
                  <p className="text-lg text-richblack-200">Toplam Kurs</p>
                  <p className="text-3xl font-semibold text-richblack-50">
                    {courses.length}
                  </p>
                </div>
                <div>
                  <p className="text-lg text-richblack-200">Toplam Öğrenci</p>
                  <p className="text-3xl font-semibold text-richblack-50">
                    {totalStudents}
                  </p>
                </div>
                <div>
                  <p className="text-lg text-richblack-200">Toplam Gelir</p>
                  <p className="text-3xl font-semibold text-richblack-50">
                    ₺ {totalAmount}
                  </p>
                </div>
          ...
          <div className="rounded-md bg-richblack-800 p-6">
            <div className="flex items-center justify-between">
              <p className="text-lg font-bold text-richblack-5">Kurslarınız</p>
              <Link to="/dashboard/my-courses">
                  ...
                  <div className="mt-3 w-full">
                    ...
                    <div className="mt-1 flex items-center space-x-2">
                      <p className="text-xs font-medium text-richblack-300">
                        {course.studentsEnrolled.length} öğrenci
                      </p>
                      <p className="text-xs font-medium text-richblack-300">
                        |
                      </p>
        ...
        <div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
          <p className="text-center text-2xl font-bold text-richblack-5">
            Henüz herhangi bir kurs oluşturmadınız
          </p>
