...
const VideoDetails = () => {
  ...
  // Dersin kursun ilk videosu olup olmadığını kontrol eder
  const isFirstVideo = () => {
  ...
  // Dersin kursun son videosu olup olmadığını kontrol eder
  const isLastVideo = () => {
    const currentSectionIndx = courseSectionData.findIndex(
      (data) => data._id === sectionId
    );
  ...
  // Küçük ekranlarda sidebar açıksa videoyu ve içeriği gizle
  if (courseViewSidebar && window.innerWidth <= 640) return;

  return (
    <div className="flex flex-col gap-5 text-white">
      {/* Mobilde menüyü açma simgesi */}
      <div
      ...
      {!videoData ? (
        ...
        >
          ...
          {/* Video bittiğinde gösterilecek içerik */}
          {videoEnded && (
            <div
              style={{
                backgroundImage:
            ...
            >
              {!completedLectures.includes(subSectionId) && (
                <IconBtn
                  ...
                  text={
                    !loading ? "Tamamlandı Olarak İşaretle" : "Yükleniyor..."
                  }
