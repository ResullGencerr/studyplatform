  ...
  const [showArrow, setShowArrow] = useState(false);
    ...
    if (token) {
      ...
      if (sessionId) {
        ...
        console.log("📡 Oturum gönderildi:", sessionId);
      }

      socket.on("FORCE_LOGOUT", () => {
        alert("Başka yerden giriş yapıldı. Oturum kapatılıyor.");
        dispatch(logout(navigate)); // Redux + yönlendirme
      });
    }
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              {" "}
              {/* Giriş yapmadan canlı yayına girilmesin */}
              <LiveRoom />
            </ProtectedRoute>
          }
        />
